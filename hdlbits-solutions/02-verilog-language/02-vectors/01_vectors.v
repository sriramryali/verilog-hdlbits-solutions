...
module top_module(
    input [2:0] vec,      // wire [msb : lsb] name, the size of the vector is mentioned before its name, ex: reg [0:3] latch -> a 4-bit vector, 0 -> MSB 3-> LSB, -ve ranges are also allowed
